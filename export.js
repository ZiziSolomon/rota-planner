...
import { dayView, typeView, statsHtml, legendHtml } from "./view.js?v=6";
import { WEEKDAY } from "./model.js?v=6";
...
<p class="foot">Generated by the browser rota planner ${VERSION}. Every hard rule in force at
the time of export is satisfied by this rota.</p>
</body></html>`;
}
